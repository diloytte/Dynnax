...
use crate::{db::connect::Database, models::{db::DBSnipeTarget, dtos::CreateSnipeDTO, service::snipe_target::SnipeConfig}};
...
pub async fn q_get_all_snipe_targets(db: &Database) -> Result<Vec<DBSnipeTarget>, sqlx::error::Error> {
