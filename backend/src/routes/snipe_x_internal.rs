...
use crate::{db::queries::x_snipe_targets::q_create_x_snipe_target, state::AppState, types::dtos::snipe_x::CreateXSnipeTargetDTO};
...
pub async fn create_snipe_x_target_internal(
    ...
    state
        .twitter_snipe_targets
        .insert(twitter_target_name.to_string(), twitter_snipe_target.clone());
